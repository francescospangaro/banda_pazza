...
type Props = {
  ...
  handleClose: () => void;
  handleSubmit: (
    lezioni: GeneratedLezione[]
  ) => Promise<{ success: boolean; errMsg?: string }>;
};

export default function AddLezioniModal({
  docenti,
  alunni: allAlunni,
  show,
  handleClose,
                  ...
                  <Col key={idx} xs="12">
                    <InputGroup>
                      <Button
                        ...
                        onClick={() => {
                          setAlunni((alunni) => {
                            if (alunni.length <= 1) return alunni;
                        ...
                        <>
                          ...
                          {docente &&
                            allAlunni
                              .filter(
                                (alunno) =>
                                  !docente || alunno.docenteId === docente
                              )
                              .map((alunno) => {
                                return (
