...
export default function DocenteModal<T extends Props<any>>(props: T) {
    ...
    const [password, setPassword] = useState(isEdit ? null : doGeneratePassword());
    ...
    return (
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title>{(isEdit ? 'Modifica' : 'Aggiungi') + ' docente'}</Modal.Title>
            </Modal.Header>
            ...
            <Form onSubmit={async (e) => {
                ...
                if(isEdit) {
                    ...
                    if(newDocente.cognome === docente?.cognome) newDocente.cognome = undefined;
                    if(newDocente.email === docente?.email) newDocente.email = undefined;
                ...
                <Modal.Body>
                    <div className="row g-3">
                        <Col xs="12">
                            ...
                            <Form.Control type="text" required name="nome" defaultValue={docente?.nome} />
                        </Col>
                        <Col xs="12">
                            <Form.Label>Cognome</Form.Label>
                            <Form.Control type="text" required name="cognome" defaultValue={docente?.cognome} />
                        </Col>
                        <Col xs="12">
                            <Form.Label>Codice Fiscale</Form.Label>
                            <Form.Control type="text" required name="cf" defaultValue={docente?.cf} />
                        </Col>
                        <Col xs="12">
                            <Form.Label>Email</Form.Label>
                            <Form.Control type="email" required name="email" defaultValue={docente?.email} />
                        </Col>
                        <Col xs="12">
                            ...
                            <InputGroup className="w-100" >
                                <Form.Control type="text"
                                              ...
                                              value={!isEdit || password ? (password ?? '') : '•••••••••••••••••••••••••••••••'} />
