...
type Props<T> = {
    show: boolean,
    handleClose: () => void,
    handleSubmit: (password: {oldPassword: string, newPassword: string}) => Promise<{ success: boolean, errMsg?: string }>,
}
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Form onSubmit={async (e) => {
                ...
                <Modal.Footer>
                    ...
                    <Button type="submit" disabled={executing} variant="primary">Cambia</Button>
                </Modal.Footer>
            </Form>
        </Modal>
    );
