        ...
        onSubmit={async (e) => {
          ...
          handleSubmit({
            ...
            endDate: e.currentTarget.endDate.value
              ? new Date(e.currentTarget.endDate.value)
              : null,
          });
          handleClose();
        }}
          ...
          <div className="row g-3">
            <Col xs="12">
              ...
              <Form.Control
                ...
                type="date"
                name="startDate"
                defaultValue={filter.startDate?.toLocaleDateString("en-CA", {
                  year: "numeric",
                  month: "2-digit",
                  day: "2-digit",
                })}
            ...
            <Col xs="12">
              ...
              <Form.Control
                ...
                type="date"
                name="endDate"
                defaultValue={filter.endDate?.toLocaleDateString("en-CA", {
                  year: "numeric",
                  month: "2-digit",
                  day: "2-digit",
                })}
            ...
            <Col xs="12">
              ...
              <InputGroup className="w-100 mb-1">
                ...
                <Form.Control
                  type="text"
                  name="nomeDocente"
                  defaultValue={filter.docente.nome}
                />
              </InputGroup>
              <InputGroup className="w-100 mb-1">
                ...
                <Form.Control
                  type="text"
                  name="cognomeDocente"
                  defaultValue={filter.docente.cognome}
                />
              </InputGroup>
            </Col>
            ...
            <Col xs="12">
              ...
              <InputGroup className="w-100 mb-1">
                ...
                <Form.Control
                  type="text"
                  name="nomeAlunno"
                  defaultValue={filter.alunno.nome}
                />
              </InputGroup>
              <InputGroup className="w-100 mb-1">
                <InputGroup.Text>Cognome</InputGroup.Text>
                <Form.Control
                  type="text"
                  name="cognomeAlunno"
                  defaultValue={filter.alunno.cognome}
                />
              </InputGroup>
            </Col>
          </div>
