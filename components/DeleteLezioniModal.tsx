...
export default function DeleteLezioniModal({
  show,
  handleClose,
  handleSubmit,
}: Props) {
  ...
  return (
    <Modal show={show} onHide={handleClose}>
      ...
      <Modal.Body>
        ...
        <p className="text-danger mt-3" style={{ textAlign: "center" }}>
          {errorMsg}
        </p>
      </Modal.Body>

      <Modal.Footer>
        <Button variant="secondary" disabled={executing} onClick={handleClose}>
          Annulla
        </Button>
        <Button
          type="submit"
